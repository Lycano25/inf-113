...
GamePlayManager = {
    ...
    preload: function() {
		...
		me.load.spritesheet("ave","assets/images/xx.png",98.5,90);
		me.load.spritesheet("gato","assets/images/lui.png",193,190);
    ...
    create: function() {
		...
		me.crow= me.game.add.sprite(50,30,"ave");
		me.crow.animations.add("right",[0,1,2,3,4],2,true);
		
		me.crow.animations.play("right");
		
		me.man=me.game.add.sprite(220,460,"gato");
